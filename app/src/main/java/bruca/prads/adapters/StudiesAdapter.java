...
public class StudiesAdapter extends RecyclerView.Adapter<StudiesAdapter.MyViewHolder> {

    public ArrayList<Menus> list;
    public ArrayList<Drawable> allItemsResourceID;
    private LayoutInflater inflater;
    private StudiesAdapterListener listener;
    Context context;
    ...
    public StudiesAdapter(Context context, int[] images, StudiesAdapterListener listener) {
       ...
       // allItemsResourceID = images;
        ...
        String[] tempMenusNames = res.getStringArray(R.array.mStudiesCategories);
    ...
    @Override
    public StudiesAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.grid_item, parent, false);

        return new StudiesAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final StudiesAdapter.MyViewHolder holder, int position) {
        //Album album = albumList.get(position);
        StudiesAdapter.Menus options = list.get(position);
...
*/
    ...
    public interface StudiesAdapterListener {
